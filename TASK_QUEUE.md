...
### Hygiene note — 2026-06-13

Since the 2026-05-28 review: (a) MCP Phase (i) Steps 1–4 are all complete — five tools now live (`essentials`, `lookup_object`, `search_packages`, `lookup_attribute`, `list_attributes`). Step 5 (real-world test) is next. (b) The two soft prerequisites from the 2026-05-28 review are done: *Promotion-candidate review pass* → complete 2026-06-04; *sync/convert layout bug* → complete 2026-06-05. (c) Queue otherwise unchanged — all cross-references, pairings, and fold decisions from 2026-05-28 remain valid.
