...
| Sequencer / clock | `metro` | `metro` is the clock — send `1` to start, `0` to stop, interval as a creation arg or via the right inlet. For the step UI on top of the clock, see "Step sequencer UI" above. |
